             ...
             <div class="row align-items-center">
	        	<div class="col-lg-3 pb-30">
	                    ...
	                    <div style="font-size: 15px;">
	                        <div style="min-width: 90px; display: inline-block;"><i class="fa fa-dollar" style="margin-right: 10px; margin-left: 20px;"></i><b>Ví của bạn</b> </b></div><input style="margin-left: 5px; border: none; max-width: 130px;" type="text" name="" id="" value=<%=sodu%> readonly>
	                    </div>
	           </div>
	             ...
	             <div class="col-lg-9 pb-30">
	                    <div style="border: 2px solid #ccc; border-radius: 16px; background-color: #f2f59d; text-align: center">
	                    	...
	                    	<div style="min-width: 250px; display: inline-block;"><a style="margin-top:20px; margin-bottom: 10px; font-size: 20px;"><b>Số khóa học đã chọn</b></div> </a> <input style="min-width: 200px; margin-left: 30px; border: none" type="text" name="" id="quatity" value="0" readonly>
                    		<p></p>
                    		
                    		<div style="min-width: 250px; display: inline-block;"><a style="margin-top:20px; margin-bottom: 10px; font-size: 20px;"><b>Tổng tiền</b></div> </a> <input style="min-width: 200px; margin-left: 30px; border: none" type="text" name="" id="total" value="0" readonly>
                    		<p></p>
	...
	<!-- Phần Hóa đơn -->
        ...
        <div class="modal-container js-modal-container">
            ...
            <div class="modal-body" style="margin: 20px"> 
                ...
                <div style="min-width: 200px; font-size: 15; font-weight: 600; display: inline-block;">Học viên:</div> <div style="margin-left: 30px; min-width: 200px; display: inline-block;"> Lê Thị Kim Lệ </div>
                <br>
                <div style="margin-top: 20px;min-width: 200px; font-size: 15; font-weight: 600; display: inline-block;">Số điện thoại học viên:</div> <div style="margin-left: 30px; min-width: 200px; display: inline-block;"> 0333843250 </div>

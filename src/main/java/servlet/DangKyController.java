...
public class DangKyController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dispatcher = request.getServletContext().getRequestDispatcher("/WEB-INF/Pages/DangKy.jsp");
		dispatcher.forward(request, response);
	}
	...
	protected void sendEmail(String email, String code) throws ServletException, IOException {
		...
		String content = "Chào mừng bạn đến với Internal Moon. Hãy nhập mã xác thực sau để hoàn tất đăng ký tài khoản: "
				+ code;
